...
def attack(char_name, char_class) -> str:
    """Calculate attack points for each of the characters."""
...
def defence(char_name, char_class) -> str:
    """Calculate defence points for each of the characters."""
    if char_class == 'warrior':
...
def special(char_name, char_class) -> str:
    """Calculate special points for a skill for each of the characters."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class) -> str:
    """Launch the programme to start training for the selected character."""
    if char_class == 'warrior':
